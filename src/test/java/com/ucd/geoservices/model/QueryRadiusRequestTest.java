...
public class QueryRadiusRequestTest {
	...
	public void testFullConstructor() {
		QueryRadiusRequest queryRadiusRequest = new QueryRadiusRequest(
				new Coordinates(33, 66), 2);

		assertThat(queryRadiusRequest.getCentralCoordinates(),
	...
	public void testJson() {
		QueryRadiusRequest expectedQueryRadiusRequest = new QueryRadiusRequest(
				new Coordinates(33, 66), 2);

		QueryRadiusRequest actualQueryRadiusRequest = JacksonUtil
				.convertFromJson(
						JacksonUtil.serializeToJson(expectedQueryRadiusRequest),
