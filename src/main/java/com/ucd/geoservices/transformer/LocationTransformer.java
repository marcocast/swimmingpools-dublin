...
public class LocationTransformer {
	...
	public Location geoPointToLocation(GeoPoint geoPoint) {
		return new Location(geoPoint.getObjectId(), new Coordinates(
				geoPoint.getLongitude(), geoPoint.getLatitude()),
				geoPoint.getMetadata(LocationMetaData.NAME.toString()),
				geoPoint.getMetadata(LocationMetaData.TOTAL_LOCATIONS_HERE
						.toString()));

	}

	public Location plainAddressToLocation(
			PlainAddress plainAddress, Coordinates coordinates) {
