...
public class LocationRest {
	...
	public Response queryWithRadius(final String queryRequestJson) {
		...
		return Response.ok(JacksonUtil.serializeToJson(geoService.queryWithRadius(queryRequest))).build();
	}
	...
	public Response queryWithBoundaries(final String queryRequestJson) {
		...
		return Response.ok(JacksonUtil.serializeToJson(geoService.queryWithBoundaries(queryRequest))).build();
	}
	...
	public Response queryWithAddress(final String queryAddressRadiusRequest) {
		...
		return Response.ok(JacksonUtil.serializeToJson(geoService.queryWithAddressAndRadius(queryRequest))).build();
	}
	...
	public Response add(final String locationJson) {
		...
		return Response.ok(JacksonUtil.serializeToJson(geoService.addLocation(location))).build();
	}
	...
	public Response addwithAddress(final String addressJson) {
		...
		return Response.ok(JacksonUtil.serializeToJson(geoService.addLocation(plainAddress))).build();
	}
	...
	public Response remove(final String locationJson) {
		...
		return Response.ok(JacksonUtil.serializeToJson(geoService.removeLocation(location))).build();
	}
